...
public record AnalysisResultWithExperimentDTO(
    Long id,
    Long experimentId,
    Long articleId,
    String articleTitle,
    ...
    public static AnalysisResultWithExperimentDTO fromEntity(AnalysisResult result) {
        return new AnalysisResultWithExperimentDTO(
            result.getId(),
